                            ...
                            <div class="col-md-8 offset-md-2">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Edit Customer</h3></div>
                                    <div class="card-body">
                                        <form method="post" action="{{url('update.customer/'.$edit->id)}}" enctype="multipart/form-data">
                                        	@csrf
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail1" 
                                                name="experience" placeholder="Enter Experience" value="{{$edit->shopname}}">
                                            </div>

                                            <div class="form-group">
                                                <label for="exampleInputEmail1"> Account_holder</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" 
                                                name="account_holder" placeholder="Enter account_holder" value="{{$edit->account_holder}}">
                                            </div>
                                           
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">Account_number</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" 
                                                name="account_number" placeholder="Enter account_number" value="{{$edit->account_number}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Bank_name</label>
                                                <input type="text" class="form-control" id="exampleInputPassword1"
                                                name="bank_name" placeholder="Enter bank_name" value="{{$edit->bank_name}}">
                                            </div>
                                             <div class="form-group">
                                                <label for="exampleInputEmail1">bank_branch</label>
                                                <input type="text" class="form-control" id="exampleInputEmail1" 
                                                name="bank_branch" placeholder="Enter bank_branch" value="{{$edit->bank_branch}}">
                                            </div>
                                             <div class="form-group">
